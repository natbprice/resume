---
title: "Nathaniel Price, Ph.D."
bibliography: publications.bib
nocite: |
  @balesdent_advanced_2016, @chaudhuri_nasa_2015
output:
  pdf_document:
...
`r fa(name = 'map-marker-alt')` Denver, Colorado `r fa(name = 'phone')` +19043152486 `r fa(name = 'envelope')` natbprice\@gmail.com `r fa(name = 'home')` natbprice.github.io
...
## Publications
`r fa(name = "book")` 2 book chapters
`r fa(name = "scroll")` 5 peer-reviewed journal publications
`r fa(name = "file-alt")` 5 conference papers \
